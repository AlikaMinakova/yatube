...
urlpatterns = [
    path('', include('posts.urls', namespace='posts')),  # namespace - для идентификации
    ...
    path('auth/', include('django.contrib.auth.urls')),  # встроенный обработчик для регистрации и авторизации
